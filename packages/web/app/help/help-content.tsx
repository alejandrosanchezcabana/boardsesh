...
export default function HelpContent() {
  ...
  // Memoized so accordion state changes don't rebuild ~600 lines of JSX. The
  // `t` reference changes when the locale changes, which is the only case we
  // need to invalidate on.
